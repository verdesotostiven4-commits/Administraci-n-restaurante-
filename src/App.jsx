...
const products = [
  ['Cheesecake de Maracuyá', 'Postres', 4.99, 5.75, 4.8, 'Cítrico', 'Tarta de queso cremosa con salsa artesanal de maracuyá.', 'https://images.unsplash.com/photo-1533134242443-d4fd215305ad?auto=format&fit=crop&w=900&q=80', ['Galleta molida', 'Mantequilla', 'Queso crema', 'Leche condensada', 'Crema de leche', 'Pulpa de maracuyá']],
  ['Higos con Queso', 'Postres', 6, 6.8, 4.7, 'Tradicional', 'Higos en almíbar de panela, canela y clavo con queso fresco.', 'https://images.unsplash.com/photo-1541782814459-453b99a7fae4?auto=format&fit=crop&w=900&q=80', ['Higos maduros', 'Panela', 'Canela', 'Clavo de olor', 'Queso fresco', 'Almíbar artesanal']],
  ['Torta Tres Leches', 'Postres', 3.85, 4.5, 4.9, 'Más pedido', 'Bizcocho húmedo de vainilla bañado con tres leches.', 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=900&q=80', ['Bizcocho de vainilla', 'Leche evaporada', 'Leche condensada', 'Crema de leche', 'Merengue', 'Canela']],
  ['Chicharrón Andino', 'Entradas', 5, 5.9, 4.8, 'Crocante', 'Cerdo crocante con papas, ensalada fresca y ají artesanal.', 'https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=900&q=80', ['Cerdo seleccionado', 'Papas doradas', 'Mote', 'Ensalada fresca', 'Ají artesanal', 'Limón']],
  ...
  ['Seco de Chivo Tradicional de la Sierra', 'Platos fuertes', 13, 15, 4.9, 'Especialidad', 'Chivo estofado lentamente con chicha de jora y especias.', 'https://images.unsplash.com/photo-1547592180-85f173990554?auto=format&fit=crop&w=900&q=80', ['Carne de chivo', 'Chicha de jora', 'Cebolla', 'Pimiento', 'Comino', 'Arroz', 'Plátano maduro']],
  ['Cuy Asado al Horno de Leña', 'Platos fuertes', 16.5, 18.5, 4.8, 'Andino', 'Cuy marinado en hierbas locales y asado en horno de leña.', 'https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?auto=format&fit=crop&w=900&q=80', ['Cuy', 'Ajo', 'Comino', 'Hierbas andinas', 'Papas', 'Mote', 'Salsa de maní']],
  ['Arroz con Pato al Horno', 'Platos fuertes', 15, 17, 4.7, 'Premium', 'Pato dorado sobre arroz meloso con especias de la zona.', 'https://images.unsplash.com/photo-1512058564366-18510be2db19?auto=format&fit=crop&w=900&q=80', ['Pato', 'Arroz', 'Fondo de ave', 'Cilantro', 'Pimiento', 'Arvejas', 'Especias de la casa']],
  ['Lomo de Cerdo Agridulce', 'Platos fuertes', 9, 10.5, 4.6, 'Creativo', 'Medallones de cerdo con reducción agridulce de mortiño.', 'https://images.unsplash.com/photo-1432139555190-58524dae6a55?auto=format&fit=crop&w=900&q=80', ['Lomo de cerdo', 'Mermelada de mortiño', 'Miel', 'Vinagre suave', 'Zanahoria blanca', 'Crema', 'Mantequilla']],
  ['Lomo Saltado de la Villa', 'Platos fuertes', 12, 14, 4.8, 'De la casa', 'Lomo de res salteado con cebolla, pimientos, tomate y ají.', 'https://images.unsplash.com/photo-1600891964092-4316c288032e?auto=format&fit=crop&w=900&q=80', ['Lomo de res', 'Cebolla morada', 'Pimiento', 'Tomate', 'Ají', 'Arroz', 'Papas doradas']],
