...
export default function App() {
  ...
  const filtered = useMemo(() => {
    ...
    return products.filter((p) => (category === 'Todos' || p.category === category) && `${p.name} ${p.description} ${p.category} ${p.ingredients.join(' ')}`.toLowerCase().includes(q));
  }, [query, category]);
